...
model.save('../dl_result/my_deep_learning_model.h5',dpi=300)
...
plt.savefig('../dl_result/model_accuracy.png',facecolor=fig.get_facecolor(),dpi=300)
plt.show()
...
fig = plt.gcf()
fig.set_facecolor('#f3efee')
plt.savefig('../dl_result/model_loss.png',facecolor=fig.get_facecolor(),dpi=300)
plt.show()
